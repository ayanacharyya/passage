...
def parse_args():
    ...
    parser.add_argument('--Zdiag', metavar='Zdiag', type=str, action='store', default='R23', help='Which metallicity diagnostic to use (choose between R23,R3,O3S2,O3O2,Te,P25? Default is R23')
