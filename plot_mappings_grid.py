...
def plot_ratio_model(df_ratios, ax, args):
    ...
    if args.phot_models.lower() in ['mappings', 'map']: line_names_dict = smart_dict({'OIII':'[OIII]5007', 'OII':'[OII]3727,9', 'Hb':'Hbeta', 'Ha':'Halpha', 'NII':'[NII]6584', 'SII':'[SII]6717,31', 'NeIII':'[NeIII]3869', 'NeIIi':'[NeII]128', 'NeIIIi': '[NeIII]155', 'Paa':'Pa-a', 'O32':'([OII]3727,9+[OIII]4959,5007)'}) # to map between user input line labels and line labels used in ratio_list.txt file
